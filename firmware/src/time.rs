use fugit::{KilohertzU64, TimerDuration, TimerInstant};
use futures::{Future, FutureExt, select_biased};

// TODO: check if it is possible to import LSI_FREQ from HAL
const LSI_FREQ: KilohertzU64 = KilohertzU64::kHz(32);
const TIMER_FREQ: u64 = LSI_FREQ.to_Hz() / 128;
...
pub async fn sleep(duration: Duration) {
    async_scheduler::sleep(duration.as_ticks().try_into().map_or(
